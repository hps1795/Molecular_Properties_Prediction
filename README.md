...
- Metrics for the test set is very close those of the train and validation set. This means the final model is generalized and available to be applied to the real-world coupling constant prediction without being biased.
